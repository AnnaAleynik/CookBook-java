            ...
            <form method="post">
                ...
                <div id="tags">
                    ...
                    <div class="input-group mb-2 mt-2">
                        <input class="form-control col-1 mr-3 form-control" type="text" name="tag1"
                               placeholder="Тег">
                    </div>
                    <input type="button" class="btn btn-outline-success btn-sm" value="+" id="addTag">
                </div>
                <div id="items">
                    <div class="input-group mb-2 mt-2">
                        ...
                        <input
                                ...
                                type="text"
                                name="amountIng1" placeholder="Количество">
                    </div>
                ...
                <input hidden type="number" name="amountIng" id="amount" value="1">
                <input hidden type="number" name="amountTag" id="amountTag" value="1">
