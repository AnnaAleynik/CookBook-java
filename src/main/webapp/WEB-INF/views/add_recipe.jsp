...
<t:mainLayout><div class="form-group" method="post">
    ...
    <div id="items">
        ...
        <div class="input-group mb-2"><input class="col-2 mr-2" type="text" name="item1"><input class="col-1" type="text" name="amount1"></div>
