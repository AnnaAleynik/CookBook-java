...
<t:mainLayout>
    <div class="container">
        ...
        <div><a href="<c:url value="/home"/>" class="btn btn-outline-secondary mt-md-2">Избранные рецепты</a></div>
        <div><a href="<c:url value="/add-recipe"/>" class="btn btn-outline-success  mt-md-2">Добавить свой рецепт</a>
        </div>
        <div><a href="<c:url value="/home"/>" class="btn btn-outline-secondary  mt-md-2">Мои рецепты</a></div>
